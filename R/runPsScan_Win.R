#' Run PS-Scan on Windows
#' 
#' This function runs the PS-Scan tool on a Windows system to scan protein sequences for PROSITE patterns.
#' This function constructs a command to execute PS-Scan and runs it using the Windows shell.
#'
...
#' runPsScan_Win(in_file = in_file, out_file = out_file, out_format = out_format, ps_scan = ps_scan, 
...
runPsScan_Win <- function(in_file, out_file = "prosite_psa.out", 
                          out_format = "psa", ps_scan = "ps_scan/ps_scan.pl", 
                          patterns_dat = "prosite.dat", pf_scan = "ps_scan/pfscan.exe"){
