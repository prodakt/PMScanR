    ...
    nav_panel(
      ...
      page_fillable(
        div(
          ...
          layout_columns(
            display_card("", imageOutput("logo"), fs = FALSE),
      ...
      page_sidebar(
        sidebar = sidebar(
          ...
          conditionalPanel(
            ...
            tags$div(
              fileInput("uploaded_file", "Upload File", accept = c(".gff", ".txt", ".psa")),
              selectInput("input_format", "Input Format", choices = c("gff", "psa", "prosite"))
            )
          ),
