...
out_file <- "data/out_Hb.txt"
in_file <- "data/hemoglobins.fasta"

debug(runPsScan)
runPsScan(in_file = in_file, out_file = out_file, out_format = out_format)
runPsScan(in_file = "data/hemoglobins.fasta", out_file = "Testdata/prosite_results.txt", out_format = "gff")


debug(getLogicalDrives)
getLogicalDrives()
...
gff_format <- rtracklayer::import.gff("Testdata/prosite_results.txt")
